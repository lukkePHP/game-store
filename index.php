        ...
        <div class="footer-content">
            <div class="container">
                ...
                <div class="row py-4 d-flex align-items-center">
                    ...
                    <!-- Grid column -->
                    <div class="col-md-12 col-lg-12 text-center text-md-left mb-4 mb-md-0 d-flex align-items-center justify-content-center form-register">
                        ...
                        <form class="register" action="src/controller/register-client.php" method='post'>
                            <div class="form-group">
                                ...
                                <input type="text" name="nome" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Digite seu nome" required>
